...
function renderDashboard() {
  ...
  var modules = [
    ...
    { id: 'virtual-tryon', href: '/customer/virtual-tryon', icon: 'fa-house-user', label: 'Roof Visualizer', desc: 'Preview materials & colors on your house', color: 'from-violet-500 to-purple-600', badge: 'New', badgeColor: 'bg-violet-500' },
