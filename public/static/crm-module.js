...
(function() {
  ...
  function initReports() {
    root.innerHTML = '<div style="margin-top:16px">' +
      '<div class="rm-skel-card"><div class="rm-skel-row"><div class="rm-skel rm-skel-avatar"></div><div style="flex:1"><div class="rm-skel rm-skel-line medium"></div><div class="rm-skel rm-skel-line short"></div></div></div></div>'.repeat(5) + '</div>';
  ...
  function initCustomers() {
    root.innerHTML = '<div style="margin-top:16px">' +
      '<div class="rm-skel-card"><div class="rm-skel-row"><div class="rm-skel rm-skel-avatar"></div><div style="flex:1"><div class="rm-skel rm-skel-line medium"></div><div class="rm-skel rm-skel-line short"></div></div></div></div>'.repeat(6) + '</div>';
    loadCustomers();
  }
  ...
  function customerFormHTML(c) {
    ...
    return '<div class="space-y-3">' +
      '<div class="grid grid-cols-1 sm:grid-cols-2 gap-3"><div><label class="block text-xs font-medium text-gray-400 mb-1">Name *</label><input type="text" id="cfName" autocomplete="name" enterkeyhint="next" value="' + (c.name || '') + '" class="w-full px-3 py-2 border border-white/15 rounded-lg text-sm focus:ring-2 focus:ring-brand-500"></div><div><label class="block text-xs font-medium text-gray-400 mb-1">Company</label><input type="text" id="cfCompany" autocomplete="organization" enterkeyhint="next" value="' + (c.company || '') + '" class="w-full px-3 py-2 border border-white/15 rounded-lg text-sm focus:ring-2 focus:ring-brand-500"></div></div>' +
      '<div class="grid grid-cols-1 sm:grid-cols-2 gap-3"><div><label class="block text-xs font-medium text-gray-400 mb-1">Email</label><input type="email" id="cfEmail" autocomplete="email" inputmode="email" enterkeyhint="next" value="' + (c.email || '') + '" class="w-full px-3 py-2 border border-white/15 rounded-lg text-sm focus:ring-2 focus:ring-brand-500"></div><div><label class="block text-xs font-medium text-gray-400 mb-1">Phone</label><input type="tel" id="cfPhone" inputmode="tel" autocomplete="tel" enterkeyhint="next" value="' + (c.phone || '') + '" class="w-full px-3 py-2 border border-white/15 rounded-lg text-sm focus:ring-2 focus:ring-brand-500"></div></div>' +
      '<div><label class="block text-xs font-medium text-gray-400 mb-1">Address</label><input type="text" id="cfAddress" autocomplete="street-address" enterkeyhint="next" value="' + (c.address || '') + '" class="w-full px-3 py-2 border border-white/15 rounded-lg text-sm focus:ring-2 focus:ring-brand-500"></div>' +
      '<div class="grid grid-cols-3 gap-3"><div><label class="block text-xs font-medium text-gray-400 mb-1">City</label><input type="text" id="cfCity" autocomplete="address-level2" value="' + (c.city || '') + '" class="w-full px-3 py-2 border border-white/15 rounded-lg text-sm"></div><div><label class="block text-xs font-medium text-gray-400 mb-1">Province</label><input type="text" id="cfProvince" autocomplete="address-level1" value="' + (c.province || '') + '" class="w-full px-3 py-2 border border-white/15 rounded-lg text-sm"></div><div><label class="block text-xs font-medium text-gray-400 mb-1">Postal Code</label><input type="text" id="cfPostal" autocomplete="postal-code" value="' + (c.postal_code || '') + '" class="w-full px-3 py-2 border border-white/15 rounded-lg text-sm"></div></div>' +
  ...
  window._crmAddEditInvItem = function() {
    ...
    var row = document.createElement('div');
    row.className = 'invItemRow grid grid-cols-12 gap-2 items-end mt-2';
    row.innerHTML = '<div class="col-span-6"><input type="text" class="invDesc w-full px-2 py-2 border border-white/15 rounded-lg text-sm" placeholder="Description"></div><div class="col-span-2"><input type="number" inputmode="decimal" class="invQty w-full px-2 py-2 border border-white/15 rounded-lg text-sm" value="1"></div><div class="col-span-3"><input type="number" inputmode="decimal" class="invPrice w-full px-2 py-2 border border-white/15 rounded-lg text-sm" step="0.01" placeholder="0.00"></div><div class="col-span-1"><button onclick="this.closest(\'.invItemRow\').remove()" class="text-red-400 hover:text-red-600 py-2"><i class="fas fa-times"></i></button></div>';
    container.appendChild(row);
  };
  ...
  function propItemRowHTML(idx, item) {
    ...
    return '<tr data-idx="' + idx + '">' +
      ...
      '<td class="py-1 pr-1 w-16"><input type="number" inputmode="decimal" class="w-full px-2 py-1.5 border border-white/15 rounded-lg text-sm text-center prop-item-qty" value="' + (item.quantity || 1) + '" min="0" step="any"></td>' +
      ...
      '</select></td>' +
      '<td class="py-1 pr-1 w-24"><input type="number" inputmode="decimal" class="w-full px-2 py-1.5 border border-white/15 rounded-lg text-sm text-right prop-item-price" value="' + (item.unit_price || 0) + '" min="0" step="0.01"></td>' +
    ...
    fetch('/api/crm/customers', { headers: authHeadersOnly() })
      ...
      .then(function(data) {
        ...
        body += '<div class="grid grid-cols-1 sm:grid-cols-2 gap-3">' +
          '<div><label class="block text-xs font-medium text-gray-400 mb-1">Tax Rate (%)</label><input type="number" inputmode="decimal" id="propTaxRate" class="w-full px-2 py-2 border border-white/15 rounded-lg text-sm" value="5" min="0" step="0.5"></div>' +
  ...
  window._crmEditProposal = function(id) {
    Promise.all([
      ...
      body += '<div class="grid grid-cols-1 sm:grid-cols-2 gap-3">' +
        '<div><label class="block text-xs font-medium text-gray-400 mb-1">Tax Rate (%)</label><input type="number" inputmode="decimal" id="propTaxRate" class="w-full px-2 py-2 border border-white/15 rounded-lg text-sm" value="' + (p.tax_rate || 5) + '" min="0" step="0.5"></div>' +
        '<div class="flex items-end"><div class="w-full bg-[#0A0A0A] rounded-lg border p-2 text-right"><p class="text-xs text-gray-500">Estimated Total</p><p class="text-lg font-black text-gray-100" id="propTotalDisplay">$0.00</p></div></div></div>';
  ...
  function initPipeline() {
    root.innerHTML = '<div style="display:grid;grid-template-columns:repeat(5,minmax(180px,1fr));gap:12px;margin-top:16px;overflow-x:auto">' +
      ('<div><div class="rm-skel rm-skel-line short" style="margin-bottom:12px"></div>' +
        '<div class="rm-skel-card"><div class="rm-skel rm-skel-line medium"></div><div class="rm-skel rm-skel-line short"></div></div>' +
        '<div class="rm-skel-card"><div class="rm-skel rm-skel-line medium"></div><div class="rm-skel rm-skel-line short"></div></div>' +
      '</div>').repeat(5) +
      '</div>';
    Promise.all([
  ...
  window._pipeMarkWon = function(proposalId) {
    ...
    var body = '<div class="space-y-3">' +
      ...
      '<input type="number" inputmode="decimal" id="wonDeposit" class="w-full px-3 py-2 border border-white/15 rounded-lg text-sm" placeholder="0.00" min="0"></div>' +
    ...
    Promise.all([
      ...
      var body = '<div class="space-y-3">' +
        ...
        '<div class="grid grid-cols-1 sm:grid-cols-2 gap-3">' +
          '<div><label class="block text-xs font-medium text-gray-400 mb-1">Tax Rate (%)</label><input type="number" inputmode="decimal" id="propFromReportTax" class="w-full px-2 py-2 border border-white/15 rounded-lg text-sm" value="5" min="0" step="0.5"></div>' +
    ...
    window._commAddRule = function() {
      ...
      var body = '<div class="space-y-3">' +
        ...
        '<div class="grid grid-cols-2 gap-3">' +
          ...
          '<input type="number" inputmode="decimal" id="ruleRate" class="w-full px-3 py-2 border border-white/15 rounded-lg text-sm" style="background:var(--bg-page);color:var(--text-primary)" placeholder="10" step="0.5" min="0"></div>' +
        '</div>' +
      '</div>';
    ...
    window._commEditRule = function(id) {
      ...
      var body = '<div class="space-y-3">' +
        ...
        '<div class="grid grid-cols-2 gap-3">' +
          ...
          '</select></div>' +
          '<div><label class="block text-xs font-medium mb-1" style="color:var(--text-muted)">Rate</label>' +
          '<input type="number" inputmode="decimal" id="editRate" class="w-full px-3 py-2 border border-white/15 rounded-lg text-sm" style="background:var(--bg-page);color:var(--text-primary)" value="' + rule.commission_rate + '" step="0.5" min="0"></div>' +
        '</div>' +
    ...
    window._commAddEntry = function() {
      ...
      var body = '<div class="space-y-3">' +
        ...
        '<div class="grid grid-cols-2 gap-3">' +
          ...
          '<input type="number" inputmode="decimal" id="entDeal" class="w-full px-3 py-2 border border-white/15 rounded-lg text-sm" style="background:var(--bg-page);color:var(--text-primary)" placeholder="15000" min="0"></div>' +
          '<div><label class="block text-xs font-medium mb-1" style="color:var(--text-muted)">Commission ($)</label>' +
          '<input type="number" inputmode="decimal" id="entComm" class="w-full px-3 py-2 border border-white/15 rounded-lg text-sm" style="background:var(--bg-page);color:var(--text-primary)" placeholder="1500" min="0"></div>' +
        '</div>' +
        '<div><label class="block text-xs font-medium mb-1" style="color:var(--text-muted)">Notes (optional)</label>' +
