    ...
    content.innerHTML = statusHtml + checklistHtml +
      ...
      '<div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-6">' +
        ...
        '<div class="space-y-4 ml-9">' +
          ...
          '<div>' +
            '<label class="block text-sm font-semibold text-gray-700 mb-1"><i class="fas fa-hand-sparkles mr-1 text-sky-500"></i>Opening Greeting — How Should ' + esc(c.agent_name || 'Sarah') + ' Address Callers?</label>' +
