...
<head>
  ...
  <meta name="description" content="Satellite roof measurement reports for roofing contractors in all 50 US states. $10/report after 4 free. Works in Texas, Florida, Colorado, Arizona, and every US state. Priced in CAD.">
...
app.get('/:state', (c) => {
  ...
  const faqSchema = JSON.stringify({
    ...
    "@type": "FAQPage",
    "mainEntity": [
      { "@type": "Question", "name": `Does Roof Manager work in ${state.name}?`, "acceptedAnswer": { "@type": "Answer", "text": `Yes. Roof Manager generates satellite-powered roof measurement reports for roofing contractors in ${state.name}. Google Solar API coverage is available for the vast majority of ${state.name} addresses. Reports cost $10 CAD per report after 4 free reports.` } },
...
<body class="min-h-screen" style="background:#0A0A0A;color:#fff">
  ...
  <section class="py-20 text-center" style="background:linear-gradient(135deg,#0f172a,#1e3a5f,#0c4a6e)">
    <div class="max-w-4xl mx-auto px-4">
      ...
      <p class="text-blue-300 mb-8">Reports cost <strong>$10 CAD</strong> after 4 free reports. Available across all ${state.name} metros. Insurance-ready documentation for ${state.stormProfile.primaryPeril.toLowerCase()} claims.</p>
  ...
  <section class="py-16" style="background:#0d0d0d">
    <div class="max-w-4xl mx-auto px-4">
      ...
      <div class="space-y-4">
        <div class="bg-white/5 border border-white/10 rounded-xl p-6"><h3 class="font-bold text-white mb-2">Does Roof Manager work in ${state.name}?</h3><p class="text-gray-400 text-sm">Yes. Roof Manager generates satellite-powered roof measurement reports for roofing contractors in ${state.name}. Google Solar API coverage is available for the vast majority of ${state.name} addresses. Reports cost $10 CAD after 4 free.</p></div>
...
app.get('/:state/:city', (c) => {
  ...
  const faqSchema = JSON.stringify({
    ...
    "@type": "FAQPage",
    "mainEntity": [
      { "@type": "Question", "name": `Does Roof Manager work in ${cityData.name}, ${state.name}?`, "acceptedAnswer": { "@type": "Answer", "text": `Yes. Roof Manager generates satellite roof measurement reports for roofing contractors in ${cityData.name}, ${state.name}. Reports cost $10 CAD after 4 free reports. Google Solar API coverage is excellent for ${cityData.name} addresses.` } },
      ...
      { "@type": "Question", "name": `How much does a roof measurement report cost in ${cityData.name}?`, "acceptedAnswer": { "@type": "Answer", "text": `Roof measurement reports for ${cityData.name}, ${state.name} properties cost $10 CAD per report after your 4 free trial reports. Volume discounts are available — 25-packs at $7.50/report, 50-packs at $6.95/report, and 100-packs at $5.95/report. All prices in CAD.` } },
...
<head>
  ...
  <meta name="description" content="AI-powered satellite roof measurement reports for roofing contractors in ${cityData.name}, ${state.name}. $10 CAD/report after 4 free. ${state.stormProfile.primaryPeril}. Insurance-ready documentation.">
  <meta property="og:locale" content="en_US">
...
<body class="min-h-screen" style="background:#0A0A0A;color:#fff">
  ...
  <section class="py-20 text-center" style="background:linear-gradient(135deg,#0f172a,#1e3a5f,#0c4a6e)">
    <div class="max-w-4xl mx-auto px-4">
      ...
      <p class="text-blue-300 mb-8">Reports cost <strong>$10 CAD</strong> after 4 free reports. Insurance-ready documentation delivered to your inbox.</p>
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <a href="/customer/login" class="px-8 py-4 bg-sky-500 hover:bg-sky-400 text-white font-bold rounded-xl text-lg">Get 4 Free Reports <i class="fas fa-arrow-right ml-2"></i></a>
        <a href="/pricing" class="px-8 py-4 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-xl text-lg border border-white/20">View Pricing (CAD)</a>
      </div>
  ...
  <section class="py-16" style="background:#111">
    <div class="max-w-4xl mx-auto px-4">
      ...
      <div class="space-y-4">
        ...
        <div class="bg-white/5 border border-white/10 rounded-xl p-6"><h3 class="font-bold text-white mb-2">How much does a roof measurement report cost in ${cityData.name}?</h3><p class="text-gray-400 text-sm">$10 CAD per report after your 4 free trial reports. Volume packs: 25 for $187.50 ($7.50/report), 50 for $347.50 ($6.95/report), and 100 for $595 ($5.95/report). All prices in CAD.</p></div>
