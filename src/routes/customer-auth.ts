...
// ============================================================
async function sendPasswordResetEmail(env: Bindings, toEmail: string, name: string, resetUrl: string, db?: D1Database): Promise<boolean> {
  const senderEmail = (env as any).GMAIL_SENDER_EMAIL || 'sales@roofmanager.ca'
...
customerAuthRoutes.get('/gcal/auth-url', async (c) => {
  ...
  authUrl.searchParams.set('scope', 'https://www.googleapis.com/auth/gmail.send https://www.googleapis.com/auth/calendar https://www.googleapis.com/auth/calendar.events https://www.googleapis.com/auth/userinfo.email')
