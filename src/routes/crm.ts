...
crmRoutes.post('/catalog/seed-defaults', async (c) => {
  ...
  const defaults = [
    ...
    { category: 'drip_edge', name: 'Drip Edge — Eave (Type C)', unit: 'pieces', unit_price: 8.50, coverage_per_unit: '10 ft per piece', supplier: '', is_default: 1, sort_order: 11 },
    { category: 'drip_edge', name: 'Drip Edge — Rake/Gable (Type D)', unit: 'pieces', unit_price: 9.50, coverage_per_unit: '10 ft per piece', supplier: '', is_default: 1, sort_order: 12 },
    { category: 'valley_metal', name: 'W-Valley Flashing (Aluminum)', unit: 'pieces', unit_price: 22.00, coverage_per_unit: '10 ft per piece', supplier: '', is_default: 1, sort_order: 13 },
    { category: 'nails', name: 'Roofing Nails 1-1/4" Galvanized', unit: 'boxes', unit_price: 28.00, coverage_per_unit: '5 lb box (~2 squares)', supplier: '', is_default: 1, sort_order: 14 },
    { category: 'ventilation', name: 'Ridge Vent', unit: 'pieces', unit_price: 22.00, coverage_per_unit: '4 ft per piece', supplier: '', is_default: 1, sort_order: 15 },
    { category: 'custom', name: 'Roofing Cement / Caulk', unit: 'tubes', unit_price: 8.50, coverage_per_unit: '~1 tube per 5 squares', supplier: '', is_default: 1, sort_order: 16 },
    { category: 'custom', name: 'Pipe Boot / Collar', unit: 'pieces', unit_price: 18.00, coverage_per_unit: '~2 per 1000 sq ft', supplier: '', is_default: 0, sort_order: 17 },
  ]
