  ...
  try {
    ...
    if (admin) {
      ...
      if (!recent || recent.cnt < 1) {
        ...
        const html = `<div style="font-family:-apple-system,sans-serif;max-width:480px;margin:0 auto;padding:40px 20px"><div style="text-align:center;margin-bottom:32px"><div style="background:#000;padding:20px;border-radius:12px;display:inline-block"><img src="https://www.roofmanager.ca/static/logo.png?v=20260504" alt="Roof Manager" width="180" style="max-width:180px;height:auto;display:block"/></div><p style="color:#6b7280;font-size:14px;margin:12px 0 0">Admin Password Reset</p></div><div style="background:#f8fafc;border-radius:16px;padding:32px;text-align:center"><p style="color:#374151;font-size:16px;margin:0 0 8px">Hi ${admin.name || 'Admin'},</p><p style="color:#6b7280;font-size:14px;margin:0 0 28px">Click below to reset your admin password. This link expires in 30 minutes.</p><a href="${resetUrl}" style="display:inline-block;background:#0ea5e9;color:white;font-weight:700;font-size:15px;padding:14px 32px;border-radius:10px;text-decoration:none">Reset Admin Password</a><p style="color:#9ca3af;font-size:12px;margin:24px 0 0">If you didn't request this, your password remains unchanged.</p></div></div>`
