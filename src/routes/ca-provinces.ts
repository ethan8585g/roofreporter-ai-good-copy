...
function contactCTAHTML(source: string) {
  ...
  <div class="max-w-2xl mx-auto px-4 text-center">
    ...
    <div style="background:#111;border:1px solid rgba(255,255,255,0.1);border-radius:16px;padding:24px;text-align:left">
      ...
      <p style="text-align:center;color:#6b7280;font-size:11px;margin-top:8px"><i class="fas fa-phone" style="color:#00FF88;margin-right:4px"></i>Or call us: <a href="tel:+17809833335" style="color:#00FF88">(780) 983-3335</a> &middot; <a href="mailto:sales@roofmanager.ca" style="color:#00FF88">sales@roofmanager.ca</a></p>
    </div>
  </div>
</section>`
}
