...
const STAGE_CONFIG: Record<NurtureStage, {
  ...
  '1h': {
    ...
    body: (firstName) => buildHtmlEmail({
      ...
      secondary: `Not ready yet? No problem. <a href="https://www.roofmanager.ca/report/share/d6f2df1241194230a9d6" style="color:#00CC70;text-decoration:none;font-weight:600;">See a sample report</a> first — no signup required.`,
  ...
  '24h': {
    ...
    body: (firstName) => buildHtmlEmail({
      ...
      secondary: `Want to see what a finished report looks like? <a href="https://www.roofmanager.ca/report/share/d6f2df1241194230a9d6" style="color:#00CC70;text-decoration:none;font-weight:600;">View a real one here</a> (no login required).`,
