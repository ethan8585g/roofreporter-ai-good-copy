...
export const MESSAGES: Record<Locale, MessageBundle> = {
  fr: {
    ...
    footer_tagline: 'Rapports de mesure de toit par satellite en moins de 60 secondes.',
    ...
    landing_hero_body: 'Rapports de mesure de toit par satellite en moins de 60 secondes. Surface projetée et en pente, longueurs de rives, calcul du matériel — et un CRM complet inclus.',
    ...
    landing_hero_bullet_4: 'PDF professionnel en moins d\'une minute',
