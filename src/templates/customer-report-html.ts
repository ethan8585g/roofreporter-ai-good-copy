        ...
        fallback2DSVG = generateTraceBasedDiagramSVG(
          {
            ...
            walls: trace.walls || undefined,
            windows: trace.windows || undefined,
          },
          { total_ridge_ft: 0, total_hip_ft: 0, total_valley_ft: 0, total_eave_ft: 0, total_rake_ft: 0 },
          0, 0, '', 0, 0,
          { hideMeasurements: true },
...
<body>
  <section class="page">
    <div class="brand">
      <div class="logo"><img src="https://www.roofmanager.ca/static/logo.png?v=20260512" alt="Roof Manager" style="height:48px;width:auto;display:block"/></div>
      <div class="meta">
