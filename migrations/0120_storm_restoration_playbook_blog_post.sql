-- Migration 0120: Storm Restoration Playbook Blog Post
...
<p><strong>AI receptionist handles 100% of inbound volume.</strong> A modern real-time voice agent answers every call in under 500ms, qualifies the lead conversationally, detects emergency language, books the inspection directly into the crew calendar, and writes the full transcript into the CRM. The system scales to effectively unlimited concurrent calls because each conversation runs on its own inference instance. A 200-call-per-hour surge is handled identically to a quiet Tuesday.</p>
<p>During storm deployments, the revenue per recovered call jumps from $3,000 baseline to $12,000–$45,000 storm-restoration blended averages.</p>
...
<p><strong>Satellite measurement runs automatically on lead intake.</strong> The instant the AI receptionist captures the property address, the CRM triggers an AI-native satellite measurement. Within 60 seconds of the call ending, the lead record has slope-adjusted area, per-facet pitch and azimuth, linear edges, and a pre-priced full-envelope estimate attached.</p>
...
<ol>
<li><strong>Identify the reason for contact.</strong> Reference the specific weather event, the specific damage you''ve seen in the neighborhood, and (if applicable) the specific addresses where you''ve already signed contracts. Specificity beats generic "storm damage" language by a factor of two in door-knock conversion studies.</li>
<li><strong>Offer the no-cost inspection.</strong> Frame it as an inspection, not a sales call. Homeowners respond to "free roof inspection" far more than to "free estimate" — the first implies expertise offered, the second implies sales pressure coming.</li>
<li><strong>Explain the insurance process if applicable.</strong> Many homeowners in first-storm markets don''t understand that a qualifying hail claim costs them only the deductible. A 60-second explanation of the contingency process — roofer does the work, insurance pays the roofer directly, homeowner pays deductible — materially lifts sign rates.</li>
<li><strong>Book the inspection, not the contract.</strong> The goal of the door knock is a scheduled inspection, not an on-the-spot sale. Reps who try to close at the door convert at roughly half the rate of reps who book an inspection and come back to complete the full damage walk.</li>
</ol>
...
<p>What a modern contingency agreement workflow looks like:</p>
<ul>
...
<tbody>
<tr style="border-bottom:1px solid #e2e8f0"><td style="padding:10px 14px">Inbound call handling</td><td style="padding:10px 14px">AI voice receptionist</td><td style="padding:10px 14px">Answers all calls, qualifies, books, routes emergencies</td></tr>
<tr style="border-bottom:1px solid #e2e8f0;background:#f8fafc"><td style="padding:10px 14px">CRM</td><td style="padding:10px 14px">Roofing-specific CRM</td><td style="padding:10px 14px">Houses leads, jobs, contracts, communications</td></tr>
<tr style="border-bottom:1px solid #e2e8f0"><td style="padding:10px 14px">Measurement</td><td style="padding:10px 14px">AI-native satellite + drone</td><td style="padding:10px 14px">Produces insurance-ready reports in 60 seconds</td></tr>
<tr style="border-bottom:1px solid #e2e8f0;background:#f8fafc"><td style="padding:10px 14px">Estimating</td><td style="padding:10px 14px">Integrated with measurement</td><td style="padding:10px 14px">Auto-prices full-envelope from measurement data</td></tr>
<tr style="border-bottom:1px solid #e2e8f0"><td style="padding:10px 14px">Contract execution</td><td style="padding:10px 14px">E-signature embedded in CRM</td><td style="padding:10px 14px">Contingency agreements signed on-tablet</td></tr>
<tr style="border-bottom:1px solid #e2e8f0;background:#f8fafc"><td style="padding:10px 14px">Insurance claim submission</td><td style="padding:10px 14px">Carrier portal integration</td><td style="padding:10px 14px">Signed contingency forwarded within 24 hours</td></tr>
<tr style="border-bottom:1px solid #e2e8f0"><td style="padding:10px 14px">Supplement documentation</td><td style="padding:10px 14px">Drone + photo CRM attachments</td><td style="padding:10px 14px">Damage evidence for adjuster + supplement file</td></tr>
<tr style="border-bottom:1px solid #e2e8f0;background:#f8fafc"><td style="padding:10px 14px">Production scheduling</td><td style="padding:10px 14px">CRM job board</td><td style="padding:10px 14px">Dispatches crews based on approval + materials</td></tr>
<tr><td style="padding:10px 14px">Customer communication</td><td style="padding:10px 14px">Automated SMS/email sequences</td><td style="padding:10px 14px">Keeps customers informed between sign and install</td></tr>
</tbody>
</table></div>
